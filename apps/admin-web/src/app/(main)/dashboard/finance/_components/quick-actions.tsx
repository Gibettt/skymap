...
const adminShortcuts = [
  ...
  { id: 2, label: "Payouts", icon: SendHorizontal, href: "/dashboard/admin/finance#payouts" },
  ...
  { id: 8, label: "Invoices", icon: ReceiptText, href: "/dashboard/admin/invoices" },
];
            ...
            <div className="flex items-center gap-1">
              <AvatarGroup>
                {contactItems.map((contact) => (
                  <Avatar key={contact.id} className="size-7" title={contact.name}>
              ...
              {adminMode ? (
                <Button size="icon-sm" variant="ghost" asChild>
                  <Link href="#payouts">
                    <ChevronRight />
                    <span className="sr-only">Review staff payouts</span>
                  </Link>
                </Button>
              ) : (
        ...
        <CardContent>
          <Field orientation="horizontal">
            <InputGroup>
              ...
              <InputGroupInput
                aria-label={adminMode ? "Open payout amount" : "Transfer amount"}
                placeholder="0.00"
                readOnly={adminMode}
                value={adminMode ? amount : undefined}
              />
