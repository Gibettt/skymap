...
import { useCreatePackageMutation, useResortsQuery } from '@/lib/apiQueries';
...
export default function CreatePackagePage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setMessage(error.message || 'Gagal membuat package.');
    }
  };
    ...
    <div className="fade-in-up package-create-page">
      <div className="form-booking-toolbar package-create-toolbar">
        <div>
          ...
          <p>Lengkapi informasi package untuk landing dan staff.</p>
        </div>
      </div>
        ...
        <form className="card-body" onSubmit={handleSubmit}>
          ...
          <div className="package-create-actions">
            ...
            <button className="btn btn-primary" type="submit" disabled={createMutation.isPending}>
              {createMutation.isPending ? 'Menyimpan...' : 'Tambah Package'}
            </button>
          </div>
        </form>
      </section>
