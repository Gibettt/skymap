export const ALERTS = [
  ...
  { id: 6, severity: 'Info', title: 'Update Data SpaceCat ASTROTOURISM', body: 'Sinkronisasi data orbital terbaru dari MPC (Minor Planet Center) berhasil.', source: 'Sistem Pusat', time: '1 hari lalu', isOpen: false },
