...
"Xingguan" (Chinese: æ˜Ÿå®˜, xÄ«ngguÄn, meaning "Star officials"). Xinguuans have
...
Luminaries_ (Chinese: ä¸ƒæ›œ, qÄ«yÃ o), which correspond to the Yin, the Yang and the
...
The Sun and the Moon are named Taiyang (Sun, Chinese: å¤ªé˜³) and Taiyin (Moon,
Chinese: å¤ªé˜´) composed from the words "tÃ i" (Great, Chinese: å¤ª) and "Yin" or
"Yang". Their other name belongs to pictographic characters Ri (Sun, Chinese:
æ—¥) and Yue (Moon, Chinese: æœˆ) but the more commonly used name for the moon is
Yueliang (Chinese: æœˆäº®, yuÃ¨liÃ ng).
...
Purple Forbidden Palace (Chinese: ç´«å¾®åž£, ZÇwÄ“i yuÃ¡n) surrounds almost the whole
circumpolar area while the enclosures of the Supreme Palace (Chinese: å¤ªå¾®åž£,
TÃ iwÄ“i yuÃ¡n) and the Heavenly Market (Chinese: å¤©å¸‚åž£, TiÄnshÃ¬ yuÃ¡n) are located
...
BoÃ¶tes, and parts of Ursa Major, Canes Venatici, Leo Minor, Hercules. It
...
The 28 Lunar Mansions (Chinese: å®¿, xiÃ¹) [#10] are slices of right ascensions in
...
the regions of the XiÃº (mansions) extend from there towards the equatorial pole
...
more. The smallest slice extends on only 1Â° of right ascension.
...
called "added stars" (Chinese: å¢žæ˜Ÿ, zÄ“ng xÄ«ng) while the stars from the
original catalogue are called "proper stars" (Chinese: æ­£æ˜Ÿ, zhÃ¨ng xÄ«ng).
...
Catalogue 1950.0_ (Chinese: ä¸­è¥¿å¯¹ç…§æ’æ˜Ÿå›¾è¡¨ 1950.0, ZhÅngxÄ« DuÃ¬zhÃ o HÃ©ngxÄ«ng TÃºbiÇŽo).
...
called the determinative star (Chinese: è·æ˜Ÿ, jÃ¹xÄ«ng) of the mansions. The
equatorial degrees of the lodge (Chinese: å®¿åº¦, xiÃ¹dÃ¹) are all right ascensions
...
The 28 mansion asterisms are grouped into Four Holy Beasts (Chinese: è±¡, xiÃ ng),
...
|---------------|---------|------|-------|-------|-----|------|------|-------|
|Chinese Name    |ä¸œæ–¹è‹é¾™ | è§’å®¿ | äº¢å®¿   | æ°å®¿   | æˆ¿å®¿ | å¿ƒå®¿  | å°¾å®¿   | ç®•å®¿   |
|Pinyin          |DÅngfÄng CÄnglÃ³ng |JiÇŽoxiÃ¹ |KÃ ngxiÃ¹ |DÄ«xiÃ¹ |FÃ¡ngxiÃ¹ |XÄ«nxiÃ¹ |WÄ›ixiÃ¹ |JÄ«xiÃ¹ |
...
|Determinative Star |  | Î± Vir | Îº Vir | Î±2 Lib | Ï€ Sco | Ïƒ Sco | Î¼1 Sco | Î³ Sgr |

|Chinese Name    | åŒ—æ–¹çŽ„æ­¦  | æ–—å®¿ | ç‰›å®¿ | å¥³å®¿ | è™šå®¿ | å±å®¿ | å®¤å®¿ | å£å®¿ |
|---------------|---------|------|-------|-------|-----|------|------|-------|
|Pinyin | BÄ›ifÄng XuÃ¡nwÇ” | DÇ’uxiÃ¹ | NiÃºxiÃ¹ | NÇšxiÃ¹ | XÅ«xiÃ¹ | WÄ“ixiÃ¹ | ShÃ¬xiÃ¹ | BÃ¬xiÃ¹ |
...
|Determinative Star  |    |Î¼ Sgr | Î² Cap | Îµ Aqr | Î² Aqr | Î± Aqr | Î± Peg | Î³ Peg |


| Chinese Name | è¥¿æ–¹ç™½è™Ž | å¥Žå®¿ | å¨„å®¿ | èƒƒå®¿ | æ˜´å®¿ | æ¯•å®¿ | è§œå®¿ | å‚å®¿ |
|---------------|---------|------|-------|-------|-----|------|------|-------|
| Pinyin |XÄ«fÄng BÃ¡ihÇ” | KuÃ­xiÃ¹ | LoÃºxiÃ¹ | WÃ¨ixiÃ¹ | MÇŽoxiÃ¹ | BÃ¬xiÃ¹ | ZÄ«xiÃ¹ | ShÄ“nxiÃ¹ |
...
| Determinative Star |    | Î¶ And | Î² Ari | 35 Ari | 17 Tau | Îµ Tau | Î» Ori | Î¶ Ori |

| Chinese Name | å—æ–¹æœ±é›€ | äº•å®¿ | é¬¼å®¿ | æŸ³å®¿ | æ˜Ÿå®¿ | å¼ å®¿ | ç¿¼å®¿ | è½¸å®¿ |
|---------------|---------|------|-------|-------|-----|------|------|-------|
| Pinyin | NÃ¡nfÄng ZhÅ«quÃ¨ | JÇngxiÃ¹ | GuÇxiÃ¹ | LiÇ”xiÃ¹ | XÄ«ngxiÃ¹ | ZhÄngxiÃ¹ | YÃ¬xiÃ¹ | ZhÄ›nxiÃ¹ |
...
| Determinative Star |  | Î¼ Gem | Î¸ Cnc | Î´ Hya | Î± Hya | Ï…1 Hya | Î± Crt | Î³ Crv |
...
(Chinese:å¾å…‰å¯, XÃº GuÄngqÇ) introduced another 23 Xingguans based on the
knowledge of European star charts. These Xingguans were since incorporated into
the traditional Chinese star maps.

![](hunxiang.webp)
_Xingguans Map of Celestial Globe (Su Songï¼ŒSong dynasty)_
{: .img_and_caption}
...
|--------------|--------------|----------|--------------|-----------|
| NGC 6231     | ç¥žå®«          | shÃ©ngÅng | God's Palace | Northern Jewel Box Cluster |
| NGC 6475/M 7 | é±¼           | YÃº        | Fish         | Ptolemy Cluster |
| NGC 2632/M 44 | ç§¯å°¸         | JÄ«ShÄ«    | Cumulative Corpses | Beehive Cluster |
| NGC 5139     | åº“æ¥¼å¢žä¸€      | KÃ¹lÃ³u ZÄ“ng I | Arsenal Added I | Omega Centauri |
| NGC 224/M 31 | å¥Žå®¿å¢žå»¿ä¸€     | KuÃ­xiÃ¹ ZÄ“ng XXI | Legs Mansion XXI | Andromeda Galaxy |
| NGC 3372     | æµ·å±±äºŒ        | HÇŽishÄn II   | Sea and Mountain II  | Homunculus Nebulaï¼ŒEta Carinae |

### Notes

This sky culture is based on the information in _Chinese and Western Contrast
Stars Chart and Star Catalogue 1950.0_ (Star Catalogue). (Chineseï¼š
ä¸­è¥¿å¯¹ç…§æ’æ˜Ÿå›¾è¡¨1950.0(æ˜Ÿè¡¨åˆ†å†Œ))ï¼Œand _Complete Studies of Astronomical Instruments_
(Chineseï¼š ä»ªè±¡è€ƒæˆ).
...
Chinese Star Catalogue for Stellarium (Chineseï¼š Stellarium ä¸­å›½æ˜Ÿå®˜ä½“ç³»ä¸‹ä¸­æ–‡æ˜Ÿåæ‰©å±•åŒ…) is a
...
Star Names (Chineseï¼š ä¸­å›½æ˜ŸåŒºã€æ˜Ÿå®˜åŠæ˜Ÿåè‹±è¯‘è¡¨). Only a small portion of the translation is
...
## References
 ...
 - [#11]: _Complete Studies of Astronomical Instruments_ (Chineseï¼š ä»ªè±¡è€ƒæˆ)
...
Sun Shuwei contributed more than 200 Xingguans and more than 3,000 starsï¼Œbased
