...
- _BintoÐµÌ€ng BaluÐµÌ€_, `Widow Before Marriage`, (Î±, Î² Cen)
- _BintoÐµÌ€ng Bola KÐµÌ€ppang_, `Incomplete House` (Î± to Î´, Î¼ Cru)
- _BintoÐµÌ€ng BalÐµÌ€ MangiwÐµÌ€ng_, `Shark` (Scorpius (south))
- _BintoÐµÌ€ng LambaruÐµÌ€_, `Ray Fish` or `Skate` (Scorpius (north))
- `Lost Pleiad` (Antares)
- _BintoÐµÌ€ng Kappala'ÐµÌ€_, `Ship` (Î± to Î· UMa)
- _BintoÐµÌ€ng Kappala'ÐµÌ€_, `Ship` (Î± to Î· UMa; Î², Î³ UMi)
- _BintoÐµÌ€ng Balu Mandara'_, `Mandar Widow` (Î±, Î² UMa)
- _BintoeÌng Timoro'_, `Eastern Star` (Altair)
- _BintoeÌng RakkalaeÌ_, `Plough` (Î± to Î· Ori)
- _Tanra TÐµÌ€lluÐµÌ€_, `Sign of Three` (Î´, Îµ, Î¶ Ori)
- _Worong-porongngeÌ_, `Cluster`, or _BintoeÌng Pitu_, `Seven Stars` (Pleiades).
...
- _Tanra Tellu_, `Triple Beacon` (Î´, Îµ, Î¶ Ori)
- _Manu'_, `Chicken` (Canopus, Sirius and Procyon)
- _Watang-mpata_, `Job's Tears Stalk` (Î±, Î² Leo)
- _Ã‰ppang_, `Lame` (Crux)
- _Walu_, `Widow` (Î±, Î² Cen)
- _Lambaru_, `Ray Fish` (Scorpius (north))
- _TeÌkkoroso_, `Pushed Plough` (Triangulum).
...
Venus is _BintoÐµÌ€ng Bawi_ or _Wari wariÐµÌ€_.

### Other sky objects

One source attributed in [#1] and [#2] gives the following Bugis names:

- _BembeÌ'eÌ_, `Goat` (Coalsack Nebula in Crux)
- _Tanra BajoeÌ_, `Sign of the Bajau` (Magellanic Clouds)
- _BintoÐµÌ€ng NagaÐµÌ€_ (the Milky Way).

## References

 - [#1]: Yukio Ohashi and Wayne Orchiston. The evolution of local Southeast Asian astronomy and the influence of China, India, the Islamic World and the West. In W Orchiston and M N Vahia, editors, Exploring the History of Southeast Asian Astronomy, pages 673â€“767. Springer, Cham, 2021.
 - [#2]: A. A. Rasyid, T. Hidayat, and W. Orchiston. Star patterns in Mandar navigation. In W. Orchiston and M. N. Vahia, editors, Exploring the History of Southeast Asian Astronomy, pages 549â€“564. Springer, Cham, 2021.
