...
commonly known constellations related to lunar mansions, called _Naká¹£atra_-s.
...
"mÄsÄ". The names of the solar months originated from these constellation's
names.

### Naká¹£atra (à¤¨à¤•à¥à¤·à¤¤à¥à¤°à¤®à¥)

In Hindu tradition the ecliptic is divided into 27 parts of approximately
13Â°20", mirroring the siderial month and corresponding to 27 asterisms known as
the _naká¹£atra_-s [#4]. In the earliest extant layers of the tradition this
...
Surya Siddhanta and Vedanga-Jyotisha specify start coordinates for the 13Â°20"
divisions using some stars [#2].

The earliest complete lists of _naká¹£atra_ are found in the _TaittirÄ«ya-Å›ruti_
and the _Atharvaveda_ where they are recited as part of the _naká¹£atreá¹£á¹­i_
...
the _naká¹£atra_ identification had changed to a small degree from the Vedic
period.
...
(=Chandra) overly favored one daughter (rohinÄ«) over the others, thus
...
month, he would grow for fifteen days (or "PakshÄ") in one half and in the
other half he would keep losing one shade (or "KalÄ") per lunar day (or
"tithi") and decrease in size.

The names of the lunar months originated from those 12 division names in which
full moon or "PurnimÄ" occurs. Unlike a solar day which is defined by a sunrise
...
|--------------|--------------|------------|--------|
| Meá¹£a         | VaiÅ›akhÄ     | Apr-May    | GrÄ«á¹£ma (Summer) |
| Vá¹›á¹£abha      | Jyeá¹£á¹­ha      | Mayâ€“June   | GrÄ«á¹£ma (Summer) |
| Mithuna      | Äá¹£Äá¹›Ä        | Juneâ€“July  | Vará¹£Ä (Monsoon) |
| Karkaá¹­a      | Å›rabaá¹‡Ä      | July-Aug   | Vará¹£Ä (Monsoon) |
| Siá¹ƒha        | BhÄdra       | Aug-Sept   | Åšarad (Autumn) |
| KanyÄ        | AÅ›vin        | Sept-Oct   | Åšarad (Autumn) |
| TulÄ         | KÄrtik       | Oct-Nov    | Hemanta (Pre-Winter) |
| Vá¹›Å›cika      | AgÄhÄna      | Nov-Dec    | Hemanta (Pre-Winter) |
| Dhanu        | Pauá¹£a        | Dec-Jan    | ÅšiÅ›ira (Winter) |
| Makara       | Magha        | Jan-Feb    | ÅšiÅ›ira (Winter) |
| Kumbha 	     | phÄlguna     | Feb-Mar    | Vasanta (Spring) |
| MÄ«na         | ChaitrÄ      | Mar-Apr    | Vasanta (Spring) |
|  -           | AdhikÄ       | Leap month |  -  |

A few of the _yogatÄrÄ_-s or prominent asterisms in the _naká¹£atra_-s (going by
...
alternate identifications for such _yogatÄrÄ_-s.
...
|-------|-------------|--------------------|
| SÅ«rya (Sun) | Sun God | RavivÄsara (Sunday) |
| Chandra/Soma (Moon) | Moon god | SomavÄsara (Monday) |
| Maá¹…gala (Mars) | God of war | Maá¹…galavÄsara (Tuesday) |
| Budha (Mercury) | Son of Moon | BudhavÄsara (Wednesday) |
| Bá¹›ihaspati/Guru (Jupiter) | Teacher of Gods | GuruvÄsara (Thursday) |
| Åšukra (Venus) | Mentor of Demons | ÅšukravÄsara (Friday) |
| Åšani (Saturn) | God of Misfortune | ÅšanivÄsara (Saturday) |
| Rahu | lunar node |  -  |
| KetÃº | lunar node |  -  |
...
## References
 ...
 - [#3]: Nakshatra: [article on Sanskrit Wikipedia](https://sa.wikipedia.org/wiki/à¤¨à¤•à¥à¤·à¤¤à¥à¤°à¤®à¥)
