...
rise and set in order to know oneÊ»s bearing. Wayfinder Nainoa Thompson (born
...
(PVS), founded in 1973, created Hokuleâ€™a in 1975. Hokuleâ€™a is a traditional
...
the lines that point directly to North and South. The star linesâ€™ position in
...
| Native Name        | Season               |
|--------------------|----------------------|
| _Ke Ka o Makaliâ€˜i_ | November to April    |
| _Ka Iwikuamoâ€˜o_    | April to July        |
...
Hawaiians to sail around the world during the Malama Honua Voyage of Hokuleâ€™a,
the Polynesian voyaging canoe. Stellarium has been used as a tool by the
navigators of Hokuleâ€™a and this sky culture serves as a tool for practicing
...
The direct translation means the â€œCanoe Bailer of Makaliâ€™iâ€. The lines are
shaped as a canoe bailer which scoops _Ka Hei-Hei o Na Keiki_ (Orion) and
_Makaliâ€™i_ (Pleiades) up into the night sky. In voyaging a bailer is used to
scoop up water out of the hulls.

The main stars of _Ke Ka o Makaliâ€™i_ from North to South are _Hokulei_
(Capella), _Nanamua_ (Castor), _Nanahope_ (Pollux), _Puana_ (Procyon), and
_â€˜Aâ€™a_ (Sirius). These stars connect together to create the bailer in the sky.
...
Mirzim (next to _â€˜Aâ€™a_ (Sirius)) and _Ke Aliâ€™i Kona i Ka Lewa_ (Canopus)
connect together to create a southern pointer. _â€˜Ekekeuehuehu_ (Î¸ Aur, Mahasim)
and _â€˜Ekekeuâ€™enaâ€™ena_ (Î² Aur, Menkalinan) connect to create a northern pointer.
Different north/south pointers are found in the star lines and used heavily by
navigators.

##### Ka Iwikuamoâ€™o

_Ka Iwikuamoâ€™o_ translates to the backbone (directly: Bone back-lizard). This
star line is depicted as the backbone of a lizard or _moâ€™o_ in this sky
culture. It can also be representing a genealogical backbone, each star
representing a generation.

The star line itself starts with _Hokupaâ€™a_ (North Star), the ultimate northern
pointer due to the star never moving in the sky, always above north. _Hokupaâ€™a_
connects down to _Na Hiku_ (Big Dipper). _Na Hiku_ translates to â€œThe Sevenâ€ as
there is seven stars in the Big Dipper. _Hokuleâ€™a_ (Arcturus) and _Hikianalia_
(Spica) are the two stars in the middle of the star line. The two PVS canoes
are named after these two stars. _Hokuleâ€™a_ is the â€œzenithâ€ star of Hawaiâ€™i,
meaning it will be directly overhead when you are at the latitude of the
Hawaiian Islands. _Hokuleâ€™a_ is very important to navigators on finding their
way back to Hawaiâ€™i. The meaning of _Hokuleâ€™a_ is â€œthe star of gladnessâ€
because it is the star used to find home bringing joy. Next to _Hikianalia_ is
_Meâ€™e_, a combination of four stars that create a box. _Meâ€™e_ connects down to
_Hanaiakamalama_ (Southern Cross) which is the southern pointer for _Ka
Iwikuamoâ€™o_.

##### Manaiakalani

_Manaiakalani_ translates to â€œThe Chief's Fishlineâ€. This refers to the legend
of the demi god Maui and his fish hook. Maui is credited for pulling up the
islands with his magical fish hook.

This star line consists of two constellations. The Navigatorâ€™s Triangle on the
north and Mauiâ€™s fish hook on the south. The Navigatorâ€™s Triangle is made of
...
also represent the Polynesian triangle: Hawaiâ€™i (_Hawaiki_), Rapanui (_Keoe_),
and Aotearoa (_Humu_). These three islands are pulled by the fish hook of Maui
(Scorpius).

The northern pointer is found in the Navigatorâ€™s Triangle when you connect
_Hawaiki_ (Deneb) and _Momonapikowalu_ (Î³ Cyg, Sadr). Southern pointers are in
the fish hook when you connect _Miliâ€™opu_ (Î´ Sco, Dschubba) and _Kahe_ (Ï€ Sco,
Nur), the stars on the top of the hook.

##### Ka Lupe o Kawelo

_Ka Lupe o Kawelo_ translates to â€œThe Kite of Kaweloâ€. Kawelo was a great chief
of Kauaâ€™i and Oâ€™ahu and this star line represents the kite which was lost as a
child.

The star line starts with _â€˜Iwakeliâ€™i_, meaning Chief Frigate Bird (_Fregata
Minor_). The shape of this constellation (which is Cassiopeia's W in the West)
resembles the _â€˜iwa_ bird that is known for leading voyagers to land. The
center of the star line is the Kite of Kawelo (equal to the Great Square of
Pegasus). The four stars that make the kite are named after Kaweloâ€™s greatest
ancestors: _Manokalanipo_ (Î´ Peg, Alpheratz), _Kakuhihewa_ (Î² Peg, Scheat),
_Piâ€™ilani_ (Î³ Peg, Algenib), and _Keawe_ (Î± Peg, Markab). All four were famous
chiefs of their time. The star line then connects south to two stars _Piâ€™ikea_
(Î² Cet, Deneb Kaitos) and _Kukaniloko_ (Î± PsA, Fomalhaut).

The northern pointer is found in _Manokalanipo_ (Î´ Peg, Alpheratz) and
_Kealohalani-po-keao_ (Î² Cas, Caph) of _â€˜Iwakeliâ€™i_. The southern pointer is
connected with _Keawe_ (Î± Peg, Markab) and _Kukaniloko_ (Î± PsA, Fomalhaut).
...
Celestial Navigation class at Kamehameha Schools Kapalama, Honolulu, Hawaiâ€™i.
