...
import { siClaude, siLinear, siResend, type SimpleIcon as SimpleIconType } from "simple-icons";
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-muted-foreground text-sm leading-none">
              You have <span className="font-medium text-foreground">{count ?? transactions.length}</span> {summaryLabel}
            </p>
          </div>
