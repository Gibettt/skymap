...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('admin@ephemeris.id');
          ...
          <div style={{
            ...
            <div style={{ fontSize: '12px', color: 'rgba(242,241,237,0.4)', display: 'flex', flexDirection: 'column', gap: '4px', fontVariantNumeric: 'tabular-nums' }}>
              <div>
                ...
                <span style={{ color: 'rgba(242,241,237,0.6)', fontFamily: 'monospace' }}>{DEMO_USERS[selectedRole].email}</span>
              </div>
              <div>
                <span style={{ color: 'rgba(242,241,237,0.25)' }}>Password:</span>{' '}
                <span style={{ color: 'rgba(242,241,237,0.6)', fontFamily: 'monospace' }}>{DEMO_USERS[selectedRole].password}</span>
              </div>
            </div>
          </div>
        </div>
