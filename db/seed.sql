...
VALUES
  ('Admin Ephemeris', 'admin@ephemeris.id', '+960-000-0001', 'admin', 'active', 'pbkdf2_sha256$310000$563ce7f90589ff4432d6bcf4c77e1532$d5a2b8639d71ed625c5ece39f87e44c3e054c7013d920122465cc69805aec300'),
  ('Ahmad Fauzi', 'internal@ephemeris.id', '+960-000-0002', 'internal', 'active', 'pbkdf2_sha256$310000$d607f2060a4b572f437c2bd8ed7484a1$21eecf309fee3698a1f710faef7257ec705d1160fd91b37479b1b54f42328fa0'),
  ('Budi Santoso', 'external@ephemeris.id', '+960-000-0003', 'external', 'active', 'pbkdf2_sha256$310000$b7a47773835dfd47a606d1ebf388f566$7bd015000025106c0dca5fe94a66dbdd42132943d9dad49585f62d68773f6051')
...
INSERT INTO bookings (
  ...
  package_id, staff_id, status, signed_by_guest, notes,
...
SELECT * FROM (
  SELECT
    ...
    beach_id, internal_id, 'finished_experience'::booking_status, true, 'Guest requested WhatsApp feedback link after dinner.',
  ...
  SELECT
    ...
    private_id, external_id, 'pending_review'::booking_status, false, 'Anniversary setup.',
  ...
  SELECT
    ...
    kids_id, internal_id, 'finished_experience'::booking_status, true, 'Parents will sign manual invoice at reception.',
